package com.example.budgetbee.budgetbeee.ui.transactions
...
class TransactionsAdapter(
    ...
    inner class TransactionViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(transaction: Transaction) {
            ...
            dateTextView.text = formatDate(transaction.date.time)  // Convert Date to Long

            // Set color based on transaction type
            val colorRes = if (transaction.type == Transaction.Type.INCOME) R.color.light_blue else R.color.custom_purple
